...
const styles = StyleSheet.create({
  ...
  resultName: { fontSize: 20, fontFamily: "Nunito_700Bold", color: "#fff", textAlign: "center" },
  ...
  resultPointsValue: { fontSize: 40, fontFamily: "Nunito_700Bold", color: "#fff" },
  ...
  listTitle: { fontSize: 16, fontFamily: "Nunito_700Bold", color: Colors.text, paddingHorizontal: 20, marginTop: 12, marginBottom: 8 },
  ...
  listItemPts: { fontSize: 16, fontFamily: "Nunito_700Bold", color: Colors.leaf },
  manualLink: {
